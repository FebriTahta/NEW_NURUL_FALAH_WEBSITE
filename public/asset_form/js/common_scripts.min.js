! function(t, e) {
	...
	const t = t => {
		...
		r = (t, e, i) => {
			Object.keys(i).forEach(s => {
				const n = i[s],
					a = e[s],
					r = a && o(a) ? "element" : (t => null == t ? `${t}` : {}.toString.call(t).match(/\s([a-z]+)/i)[1].toLowerCase())(a);
		...
		_ = (t, e, i = !0) => {
			...
			const a = ({
				...
				i === e && (o = !0, e.removeEventListener("transitionend", a), v(t))
			};
	...
	function M(t, e, i, s, n) {
		...
		if (i || (i = s, s = null), E.test(e)) {
			const t = t => (function(e) {
				if (!e.relatedTarget || e.relatedTarget !== e.delegateTarget && !e.delegateTarget.contains(e.relatedTarget)) return t.call(this, e)
			});
			s ? s = t(s) : i = t(i)
		}
		const [o, a, r] = P(e, i, s), l = A(t), h = l[r] || (l[r] = {}), c = T(h, a, o ? i : null);
				...
				return function s(n) {
					...
					for (let {
						...
						for (let r = o.length; r--;)
							if (o[r] === a) return n.delegateTarget = a, s.oneOff && z.off(t, n.type, e, i), i.apply(a, [n]);
					return null
				}
			}(t, i, s) : function(t, e) {
				return function i(s) {
	...
	const z = {
			...
			off(t, e, i, s) {
				if ("string" != typeof e || !t) return;
				const [n, o, a] = P(e, i, s), r = a !== e, l = A(t), h = e.startsWith(".");
				if (void 0 !== o) {
					if (!l || !l[a]) return;
			...
			trigger(t, e, i) {
				...
				let r, l = !0,
					...
					c = !1,
					u = null;
				return o && s && (r = s.Event(e, i), s(t).trigger(r), l = !r.isPropagationStopped(), h = !r.isImmediatePropagationStopped(), c = r.isDefaultPrevented()), a ? (u = document.createEvent("HTMLEvents")).initEvent(n, l, !0) : u = new CustomEvent(e, {
					bubbles: l,
					cancelable: !0
				...
				}), c && u.preventDefault(), h && t.dispatchEvent(u), u.defaultPrevented && void 0 !== r && r.preventDefault(), u
			}
		},
		N = new Map,
		L = {
	...
	class H {
		...
		dispose() {
			L.remove(this._element, this.constructor.DATA_KEY), z.off(this._element, this.constructor.EVENT_KEY), Object.getOwnPropertyNames(this).forEach(t => {
				this[t] = null
			})
		}
	...
	class K extends H {
		...
		close() {
			if (z.trigger(this._element, j).defaultPrevented) return;
			this._element.classList.remove(Y);
			const t = this._element.classList.contains(B);
	...
	const G = {
			...
			getDataAttributes(t) {
				...
				return Object.keys(t.dataset).filter(t => t.startsWith("bs")).forEach(i => {
					let s = i.replace(/^bs/, "");
					s = s.charAt(0).toLowerCase() + s.slice(1, s.length), e[s] = X(t.dataset[i])
				}), e
			},
			getDataAttribute: (t, e) => X(t.getAttribute(`data-bs-${Z(e)}`)),
			offset(t) {
	...
	class $t extends H {
		constructor(t, e) {
			super(t), this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this.touchStartX = 0, this.touchDeltaX = 0, this._config = this._getConfig(e), this._indicatorsElement = J.findOne(Ot, this._element), this._touchSupported = "ontouchstart" in document.documentElement || navigator.maxTouchPoints > 0, this._pointerEvent = Boolean(window.PointerEvent), this._addEventListeners()
		}
		static get Default() {
			return st
		}
		...
		pause(t) {
			t || (this._isPaused = !0), J.findOne(Ft, this._element) && (n(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
		}
		cycle(t) {
			t || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config && this._config.interval && !this._isPaused && (this._updateInterval(), this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.next).bind(this), this._config.interval))
		}
		to(t) {
			this._activeElement = J.findOne(Tt, this._element);
			const e = this._getItemIndex(this._activeElement);
			if (t > this._items.length - 1 || t < 0) return;
			if (this._isSliding) return void z.one(this._element, ut, () => this.to(t));
		...
		_addEventListeners() {
			this._config.keyboard && z.on(this._element, dt, t => this._keydown(t)), "hover" === this._config.pause && (z.on(this._element, pt, t => this.pause(t)), z.on(this._element, ft, t => this.cycle(t))), this._config.touch && this._touchSupported && this._addTouchEventListeners()
		}
		_addTouchEventListeners() {
			const t = t => this._pointerEvent && (t.pointerType === Lt || t.pointerType === Nt),
				e = e => {
				...
				s = e => {
					t(e) && (this.touchDeltaX = e.clientX - this.touchStartX), this._handleSwipe(), "hover" === this._config.pause && (this.pause(), this.touchTimeout && clearTimeout(this.touchTimeout), this.touchTimeout = setTimeout(t => this.cycle(t), et + this._config.interval))
				};
			J.find(Mt, this._element).forEach(t => {
				z.on(t, yt, t => t.preventDefault())
			}), this._pointerEvent ? (z.on(this._element, _t, t => e(t)), z.on(this._element, bt, t => s(t)), this._element.classList.add(St)) : (z.on(this._element, gt, t => e(t)), z.on(this._element, mt, t => i(t)), z.on(this._element, vt, t => s(t)))
		}
		_keydown(t) {
		...
		_triggerSlideEvent(t, e) {
			const i = this._getItemIndex(t),
				s = this._getItemIndex(J.findOne(Tt, this._element));
			return z.trigger(this._element, ct, {
				relatedTarget: t,
				direction: e,
				from: s,
				to: i
		...
		_setActiveIndicatorElement(t) {
			if (this._indicatorsElement) {
				const e = J.findOne(At, this._indicatorsElement);
				e.classList.remove(xt), e.removeAttribute("aria-current");
				const i = J.find(zt, this._indicatorsElement);
				for (let e = 0; e < i.length; e++)
					if (Number.parseInt(i[e].getAttribute("data-bs-slide-to"), 10) === this._getItemIndex(t)) {
						i[e].classList.add(xt), i[e].setAttribute("aria-current", "true");
						break
					}
			}
		}
		_updateInterval() {
			const t = this._activeElement || J.findOne(Tt, this._element);
			if (!t) return;
		...
		_slide(t, e) {
			...
			if (this._element.classList.contains(Ct)) {
				...
				const t = () => {
					o.classList.remove(h, c), o.classList.add(xt), s.classList.remove(xt, c, h), this._isSliding = !1, setTimeout(p, 0)
				};
				this._queueCallback(t, s, !0)
			} else s.classList.remove(xt), o.classList.add(xt), this._isSliding = !1, p();
			r && this.cycle()
		}
		_directionToOrder(t) {
			return [lt, rt].includes(t) ? g() ? t === rt ? at : ot : t === rt ? ot : at : t
		}
		_orderToDirection(t) {
			return [ot, at].includes(t) ? g() ? t === at ? rt : lt : t === at ? lt : rt : t
		}
		...
		static dataApiClickHandler(t) {
			...
			n && (i.interval = !1), $t.carouselInterface(e, i), n && $t.getInstance(e).to(n), t.preventDefault()
		}
	}
	z.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", $t.dataApiClickHandler), z.on(window, "load.bs.carousel.data-api", () => {
		const t = J.find('[data-bs-ride="carousel"]');
		for (let e = 0, i = t.length; e < i; e++) $t.carouselInterface(t[e], $t.getInstance(t[e]))
	}), m($t);
	const Ht = "collapse",
		Wt = "bs.collapse",
		Rt = `.${Wt}`,
	...
	class oe extends H {
		constructor(t, e) {
			...
			for (let t = 0, e = s.length; t < e; t++) {
				const e = s[t],
					n = i(e),
					o = J.find(n).filter(t => t === this._element);
		...
		show() {
			...
			if (this._config.parent) {
				...
				e = J.find(se, this._config.parent).filter(e => !t.includes(e))
			}
			const i = J.findOne(this._selector);
			if (e.length) {
				const s = e.find(t => i !== t);
				if ((t = s ? oe.getInstance(s) : null) && t._isTransitioning) return
			}
			if (z.trigger(this._element, Bt).defaultPrevented) return;
			e.forEach(e => {
				i !== e && oe.getOrCreateInstance(e, {
					toggle: !1
				}).hide(), t || L.set(e, Wt, null)
			});
			const s = this._getDimension();
			this._element.classList.remove(Xt), this._element.classList.add(Zt), this._element.style[s] = 0, this._addAriaAndCollapsedClass(this._triggerArray, !0), this._isTransitioning = !0;
			const n = `scroll${s[0].toUpperCase()+s.slice(1)}`;
			this._queueCallback(() => {
				this._isTransitioning = !1, this._element.classList.remove(Zt), this._element.classList.add(Xt, Qt), this._element.style[s] = "", z.trigger(this._element, Yt)
			}, this._element, !0), this._element.style[s] = `${this._element[n]}px`
		}
		hide() {
			if (this._isTransitioning || !this._isShown()) return;
			if (z.trigger(this._element, Kt).defaultPrevented) return;
			const t = this._getDimension();
			this._element.style[t] = `${this._element.getBoundingClientRect()[t]}px`, d(this._element), this._element.classList.add(Zt), this._element.classList.remove(Xt, Qt);
			...
			this._element.style[t] = "", this._queueCallback(() => {
				this._isTransitioning = !1, this._element.classList.remove(Zt), this._element.classList.add(Xt), z.trigger(this._element, Vt)
			}, this._element, !0)
		}
		...
		_getConfig(t) {
			return (t = {
				...
				...G.getDataAttributes(this._element),
				...t
			}).toggle = Boolean(t.toggle), t.parent = a(t.parent), r(Ht, t, qt), t
		}
		_getDimension() {
		...
		_initializeChildren() {
			...
			const t = J.find(Jt, this._config.parent);
			J.find(ne, this._config.parent).filter(e => !t.includes(e)).forEach(t => {
				const e = s(t);
	...
	z.on(document, Ut, ne, function(t) {
		("A" === t.target.tagName || t.delegateTarget && "A" === t.delegateTarget.tagName) && t.preventDefault();
		const e = i(this);
		J.find(e).forEach(t => {
			oe.getOrCreateInstance(t, {
				toggle: !1
			}).toggle()
		})
	}), m(oe);
	var ae = "top",
		...
		me = "popper",
		ve = "reference",
		_e = ue.reduce(function(t, e) {
			return t.concat([e + "-" + de, e + "-" + pe])
		}, []),
		be = [].concat(ue, [ce]).reduce(function(t, e) {
	...
	function De(t) {
		return "undefined" != typeof ShadowRoot && (t instanceof xe(t).ShadowRoot || t instanceof ShadowRoot)
	}
	const Ee = {
		name: "applyStyles",
		enabled: !0,
		...
		fn: function(t) {
			...
			Object.keys(e.elements).forEach(function(t) {
				var i = e.styles[t] || {},
					s = e.attributes[t] || {},
					n = e.elements[t];
				ke(n) && we(n) && (Object.assign(n.style, i), Object.keys(s).forEach(function(t) {
					var e = s[t];
			...
			return Object.assign(e.elements.popper.style, i.popper), e.styles = i, e.elements.arrow && Object.assign(e.elements.arrow.style, i.arrow),
				function() {
					Object.keys(e.elements).forEach(function(t) {
						...
						ke(s) && we(s) && (Object.assign(s.style, o), Object.keys(n).forEach(function(t) {
							s.removeAttribute(t)
						}))
					})
				}
	...
	function Fe(t) {
		return ((Ce(t) ? t.ownerDocument : t.document) || window.document).documentElement
	}

	function Oe(t) {
		return "html" === we(t) ? t : t.assignedSlot || t.parentNode || (De(t) ? t.host : null) || Fe(t)
	}
	...
	function Ne(t) {
		for (var e = xe(t), i = ze(t); i && Me(i) && "static" === Pe(i).position;) i = ze(i);
		return i && ("html" === we(i) || "body" === we(i) && "static" === Pe(i).position) ? e : i || function(t) {
			var e = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox");
			if (-1 !== navigator.userAgent.indexOf("Trident") && ke(t) && "fixed" === Pe(t).position) return null;
			for (var i = Oe(t); ke(i) && ["html", "body"].indexOf(we(i)) < 0;) {
				var s = Pe(i);
	...
	var Be = function(t, e) {
		return je("number" != typeof(t = "function" == typeof t ? t(Object.assign({}, e.rects, {
	...
	const Ye = {
		...
		fn: function(t) {
			var e, i = t.state,
				...
				r = Ie(i.placement),
				l = Le(r),
				h = [he, le].indexOf(r) >= 0 ? "height" : "width";
			if (o && a) {
				var c = Be(n.padding, i),
					u = Ae(o),
					d = "y" === l ? ae : he,
					p = "y" === l ? re : le,
		...
		effect: function(t) {
			...
			null != s && ("string" != typeof s || (s = e.elements.popper.querySelector(s))) && Te(e.elements.popper, s) && (e.elements.arrow = s)
		},
	...
	function Ue(t) {
		...
		if (h) {
			var w = Ne(i),
				x = "clientHeight",
				C = "clientWidth";
			w === xe(i) && "static" !== Pe(w = Fe(i)).position && "absolute" === r && (x = "scrollHeight", C = "scrollWidth"), w = w, n !== ae && (n !== he && n !== le || o !== pe) || (b = re, g -= w[x] - s.height, g *= l ? 1 : -1), n !== he && (n !== ae && n !== re || o !== pe) || (_ = le, p -= w[C] - s.width, p *= l ? 1 : -1)
		}
		var k, D = Object.assign({
			position: r
		}, h && Ve);
		return l ? Object.assign({}, D, ((k = {})[b] = v ? "0" : "", k[_] = m ? "0" : "", k.transform = (y.devicePixelRatio || 1) <= 1 ? "translate(" + p + "px, " + g + "px)" : "translate3d(" + p + "px, " + g + "px, 0)", k)) : Object.assign({}, D, ((e = {})[b] = v ? g + "px" : "", e[_] = m ? p + "px" : "", e.transform = "", e))
	}
	const Qe = {
		name: "computeStyles",
		enabled: !0,
		...
		fn: function(t) {
			...
			null != e.modifiersData.popperOffsets && (e.styles.popper = Object.assign({}, e.styles.popper, Ue(Object.assign({}, h, {
				offsets: e.modifiersData.popperOffsets,
				position: e.options.strategy,
				adaptive: a,
				roundOffsets: l
			})))), null != e.modifiersData.arrow && (e.styles.arrow = Object.assign({}, e.styles.arrow, Ue(Object.assign({}, h, {
	...
	const Ze = {
		...
		effect: function(t) {
			...
			return o && h.forEach(function(t) {
					t.addEventListener("scroll", i.update, Xe)
				}), r && l.addEventListener("resize", i.update, Xe),
				function() {
					o && h.forEach(function(t) {
						t.removeEventListener("scroll", i.update, Xe)
					}), r && l.removeEventListener("resize", i.update, Xe)
				}
		},
		data: {}
	};
	...
	function si(t) {
		return Se(Fe(t)).left + ii(t).scrollLeft
	}
	...
	function oi(t, e) {
		...
		void 0 === e && (e = []);
		var s = function t(e) {
				return ["html", "body", "#document"].indexOf(we(e)) >= 0 ? e.ownerDocument.body : ke(e) && ni(e) ? e : t(Oe(e))
			}(t),
			n = s === (null == (i = t.ownerDocument) ? void 0 : i.body),
			o = xe(s),
			a = n ? [o].concat(o.visualViewport || [], ni(s) ? s : []) : s,
			r = e.concat(a);
		return n ? r : r.concat(oi(Oe(a)))
	}
	...
	function ri(t, e) {
		return e === ge ? ai(function(t) {
			var e = xe(t),
				...
				a = 0,
				r = 0;
			return s && (n = s.width, o = s.height, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (a = s.offsetLeft, r = s.offsetTop)), {
				width: n,
				height: o,
				x: a + si(t),
				y: r
			...
			var e, i = Fe(t),
				...
				o = $e(i.scrollWidth, i.clientWidth, n ? n.scrollWidth : 0, n ? n.clientWidth : 0),
				a = $e(i.scrollHeight, i.clientHeight, n ? n.scrollHeight : 0, n ? n.clientHeight : 0),
				r = -s.scrollLeft + si(t),
				l = -s.scrollTop;
			return "rtl" === Pe(n || i).direction && (r += $e(i.clientWidth, n ? n.clientWidth : 0) - o), {
				width: o,
				height: a,
				x: r,
				y: l
	...
	function li(t, e, i) {
		var s = "clippingParents" === e ? function(t) {
				var e = oi(Oe(t)),
					i = ["absolute", "fixed"].indexOf(Pe(t).position) >= 0 && ke(t) ? Ne(t) : t;
				return Ce(i) ? e.filter(function(t) {
					return Ce(t) && Te(t, i) && "body" !== we(t)
				}) : []
			}(t) : [].concat(e),
			n = [].concat(s, [i]),
			o = n[0],
			a = n.reduce(function(e, i) {
				var s = ri(t, i);
				return e.top = $e(s.top, e.top), e.right = He(s.right, e.right), e.bottom = He(s.bottom, e.bottom), e.left = $e(s.left, e.left), e
			}, ri(t, o));
	...
	function ci(t, e) {
		...
		var i = e,
			...
			p = i.padding,
			f = void 0 === p ? 0 : p,
			g = je("number" != typeof f ? f : qe(f, ue)),
			m = c === me ? ve : me,
			v = t.rects.popper,
			_ = t.elements[d ? m : c],
			b = li(Ce(_) ? _ : _.contextElement || Fe(t.elements.popper), a, l),
			y = Se(t.elements.reference),
			w = hi({
				reference: y,
				element: v,
				strategy: "absolute",
		...
		if (c === me && D) {
			...
			Object.keys(k).forEach(function(t) {
				var e = [le, re].indexOf(t) >= 0 ? 1 : -1,
					i = [ae, re].indexOf(t) >= 0 ? "y" : "x";
				k[t] += E[i] * e
			})
		}
		return k
	...
	const di = {
		...
		fn: function(t) {
			...
			if (!e.modifiersData[s]._skip) {
				for (var n = i.mainAxis, o = void 0 === n || n, a = i.altAxis, r = void 0 === a || a, l = i.fallbackPlacements, h = i.padding, c = i.boundary, u = i.rootBoundary, d = i.altBoundary, p = i.flipVariations, f = void 0 === p || p, g = i.allowedAutoPlacements, m = e.options.placement, v = Ie(m), _ = l || (v !== m && f ? function(t) {
						if (Ie(t) === ce) return [];
						var e = Je(t);
						return [ei(t), e, ei(e)]
					}(m) : [Je(m)]), b = [m].concat(_).reduce(function(t, i) {
						return t.concat(Ie(i) === ce ? ui(e, {
							placement: i,
							boundary: c,
							rootBoundary: u,
							padding: h,
					...
					}, []), y = e.rects.reference, w = e.rects.popper, x = new Map, C = !0, k = b[0], D = 0; D < b.length; D++) {
					var E = b[D],
						I = Ie(E),
						S = Ke(E) === de,
						A = [ae, re].indexOf(I) >= 0,
					...
					var F = Je(M),
						O = [];
					if (o && O.push(P[I] <= 0), r && O.push(P[M] <= 0, P[F] <= 0), O.every(function(t) {
							return t
						})) {
						k = E, C = !1;
						break
	...
	function fi(t) {
		return [ae, le, re, he].some(function(e) {
			return t[e] >= 0
		})
	}
	const gi = {
	...
	const mi = {
		...
		fn: function(t) {
			var e = t.state,
				...
				n = i.offset,
				o = void 0 === n ? [0, 0] : n,
				a = be.reduce(function(t, i) {
					return t[i] = function(t, e, i) {
						var s = Ie(t),
							n = [he, ae].indexOf(s) >= 0 ? -1 : 1,
							o = "function" == typeof i ? i(Object.assign({}, e, {
								placement: t
							})) : i,
							a = o[0],
							r = o[1];
						return a = a || 0, r = (r || 0) * n, [he, le].indexOf(s) >= 0 ? {
							x: r,
							y: a
						} : {
							x: a,
			...
			if (x) {
				if (o || r) {
					var I = "y" === y ? ae : he,
						...
						W = $[S],
						R = Re(0, C[A], L[A]),
						j = b ? C[A] / 2 - F - R - H - D : O - R - H - D,
						q = b ? -C[A] / 2 + F + R + W + D : z + R + W + D,
						B = e.elements.arrow && Ne(e.elements.arrow),
						Y = B ? "y" === y ? B.clientTop || 0 : B.clientLeft || 0 : 0,
						K = e.modifiersData.offset ? e.modifiersData.offset[e.placement][y] : 0,
						V = x[y] + j - K - Y,
						U = x[y] + q - K;
					if (o) {
						var Q = Re(p ? He(P, V) : P, T, p ? $e(M, U) : M);
						x[y] = Q, E[y] = Q - T
					}
					if (r) {
						var X = "x" === y ? ae : he,
							...
							J = G + m[X],
							tt = G - m[Z],
							et = Re(p ? He(J, V) : J, G, p ? $e(tt, U) : tt);
						x[w] = et, E[w] = et - G
					}
				}
				e.modifiersData[s] = E
	...
	function bi(t, e, i) {
		...
		return (s || !s && !i) && (("body" !== we(e) || ni(a)) && (l = (n = e) !== xe(n) && ke(n) ? {
			scrollLeft: (o = n).scrollLeft,
			scrollTop: o.scrollTop
		} : ii(n)), ke(e) ? ((h = Se(e)).x += e.clientLeft, h.y += e.clientTop) : a && (h.x = si(a))), {
			...
			var n, a, r = {
				...
				c = {
					...
					setOptions: function(i) {
						...
						u(), r.options = Object.assign({}, o, r.options, n), r.scrollParents = {
							reference: Ce(t) ? oi(t) : t.contextElement ? oi(t.contextElement) : [],
							popper: oi(e)
						};
						var a, h, d = function(t) {
							var e = yi(t);
						...
						return r.orderedModifiers = d.filter(function(t) {
							return t.enabled
					...
					forceUpdate: function() {
						if (!h) {
							...
							if (xi(e, i)) {
								r.rects = {
									reference: bi(e, Ne(i), "fixed" === r.options.strategy),
									popper: Ae(i)
	...
	var ki = Ci(),
		Di = Ci({
			defaultModifiers: [Ze, vi, Qe, Ee]
		}),
		Ei = Ci({
			defaultModifiers: [Ze, vi, Qe, Ee, mi, di, _i, Ye, gi]
		});
	const Ii = Object.freeze({
		...
		Fi = "ArrowDown",
		Oi = 2,
		zi = new RegExp(`${Mi}|${Fi}|${Ai}`),
		Ni = "hide.bs.dropdown",
		Li = "hidden.bs.dropdown",
		$i = "show.bs.dropdown",
		Hi = "shown.bs.dropdown",
		Wi = "show",
		Ri = "dropup",
		ji = "dropend",
		qi = "dropstart",
		Bi = "navbar",
		Yi = '[data-bs-toggle="dropdown"]',
		Ki = ".dropdown-menu",
		Vi = ".navbar-nav",
		Ui = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)",
		Qi = g() ? "top-end" : "top-start",
		Xi = g() ? "top-start" : "top-end",
		Zi = g() ? "bottom-end" : "bottom-start",
		Gi = g() ? "bottom-start" : "bottom-end",
		Ji = g() ? "left-start" : "right-start",
		ts = g() ? "right-start" : "left-start",
		es = {
			offset: [0, 2],
	...
	class ss extends H {
		...
		show() {
			...
			if (z.trigger(this._element, $i, t).defaultPrevented) return;
			const e = ss.getParentFromElement(this._element);
			this._inNavbar ? G.setDataAttribute(this._menu, "popper", "none") : this._createPopper(e), "ontouchstart" in document.documentElement && !e.closest(Vi) && [].concat(...document.body.children).forEach(t => z.on(t, "mouseover", u)), this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.add(Wi), this._element.classList.add(Wi), z.trigger(this._element, Hi, t)
		}
		hide() {
			if (h(this._element) || !this._isShown(this._menu)) return;
			const t = {
		...
		_completeHide(t) {
			z.trigger(this._element, Ni, t).defaultPrevented || ("ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach(t => z.off(t, "mouseover", u)), this._popper && this._popper.destroy(), this._menu.classList.remove(Wi), this._element.classList.remove(Wi), this._element.setAttribute("aria-expanded", "false"), G.removeDataAttribute(this._menu, "popper"), z.trigger(this._element, Li, t))
		}
		_getConfig(t) {
			if (t = {
					...
					...G.getDataAttributes(this._element),
					...t
				}, r(Si, t, this.constructor.DefaultType), "object" == typeof t.reference && !o(t.reference) && "function" != typeof t.reference.getBoundingClientRect) throw new TypeError(`${Si.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);
			return t
		}
		_createPopper(t) {
			...
			this._popper = Ei(e, this._menu, i), s && G.setDataAttribute(this._menu, "popper", "static")
		}
		_isShown(t = this._element) {
			return t.classList.contains(Wi)
		}
		_getMenuElement() {
			return J.next(this._element, Ki)[0]
		}
		_getPlacement() {
			const t = this._element.parentNode;
			if (t.classList.contains(ji)) return Ji;
			if (t.classList.contains(qi)) return ts;
			const e = "end" === getComputedStyle(this._menu).getPropertyValue("--bs-position").trim();
			return t.classList.contains(Ri) ? e ? Xi : Qi : e ? Gi : Zi
		}
		_detectNavbar() {
			return null !== this._element.closest(`.${Bi}`)
		}
		_getOffset() {
			const {
				offset: t
		...
		_selectMenuItem({
			...
			const i = J.find(Ui, this._menu).filter(l);
			i.length && b(i, e, t === Fi, !i.includes(e)).focus()
		}
		static jQueryInterface(t) {
			return this.each(function() {
		...
		static clearMenus(t) {
			if (t && (t.button === Oi || "keyup" === t.type && t.key !== Pi)) return;
			const e = J.find(Yi);
			for (let i = 0, s = e.length; i < s; i++) {
				const s = ss.getInstance(e[i]);
				...
				if (t) {
					...
					if (s._menu.contains(t.target) && ("keyup" === t.type && t.key === Pi || /input|select|option|textarea|form/i.test(t.target.tagName))) continue;
		...
		static dataApiKeydownHandler(t) {
			if (/input|textarea/i.test(t.target.tagName) ? t.key === Ti || t.key !== Ai && (t.key !== Fi && t.key !== Mi || t.target.closest(Ki)) : !zi.test(t.key)) return;
			const e = this.classList.contains(Wi);
			if (!e && t.key === Ai) return;
			if (t.preventDefault(), t.stopPropagation(), h(this)) return;
			const i = this.matches(Yi) ? this : J.prev(this, Yi)[0],
				s = ss.getOrCreateInstance(i);
			if (t.key !== Ai) return t.key === Mi || t.key === Fi ? (e || s.show(), void s._selectMenuItem(t)) : void(e && t.key !== Ti || ss.clearMenus());
			s.hide()
		}
	}
	z.on(document, "keydown.bs.dropdown.data-api", Yi, ss.dataApiKeydownHandler), z.on(document, "keydown.bs.dropdown.data-api", Ki, ss.dataApiKeydownHandler), z.on(document, "click.bs.dropdown.data-api", ss.clearMenus), z.on(document, "keyup.bs.dropdown.data-api", ss.clearMenus), z.on(document, "click.bs.dropdown.data-api", Yi, function(t) {
		t.preventDefault(), ss.getOrCreateInstance(this).toggle()
	}), m(ss);
	const ns = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
		os = ".sticky-top";
	class as {
		constructor() {
		...
		hide() {
			...
			this._disableOverFlow(), this._setElementAttributes(this._element, "paddingRight", e => e + t), this._setElementAttributes(ns, "paddingRight", e => e + t), this._setElementAttributes(os, "marginRight", e => e - t)
		}
		_disableOverFlow() {
		...
		reset() {
			this._resetElementAttributes(this._element, "overflow"), this._resetElementAttributes(this._element, "paddingRight"), this._resetElementAttributes(ns, "paddingRight"), this._resetElementAttributes(os, "marginRight")
		}
		...
		_resetElementAttributes(t, e) {
			this._applyManipulationCallback(t, t => {
				const i = G.getDataAttribute(t, e);
				void 0 === i ? t.style.removeProperty(e) : (G.removeDataAttribute(t, e), t.style[e] = i)
			})
		}
	...
	class ps {
		...
		show(t) {
			this._config.isVisible ? (this._append(), this._config.isAnimated && d(this._getElement()), this._getElement().classList.add(us), this._emulateAnimation(() => {
				v(t)
			})) : v(t)
		}
		hide(t) {
			this._config.isVisible ? (this._getElement().classList.remove(us), this._emulateAnimation(() => {
				this.dispose(), v(t)
			})) : v(t)
		}
		_getElement() {
			if (!this._element) {
				...
				t.className = this._config.className, this._config.isAnimated && t.classList.add(cs), this._element = t
			}
		...
		_getConfig(t) {
			return (t = {
				...rs,
				..."object" == typeof t ? t : {}
			}).rootElement = a(t.rootElement), r(hs, t, ls), t
		}
		_append() {
			this._isAppended || (this._config.rootElement.append(this._getElement()), z.on(this._getElement(), ds, () => {
				v(this._config.clickCallback)
			}), this._isAppended = !0)
		}
		dispose() {
			this._isAppended && (z.off(this._element, ds), this._element.remove(), this._isAppended = !1)
		}
		_emulateAnimation(t) {
	...
	class Cs {
		...
		activate() {
			...
			this._isActive || (e && t.focus(), z.off(document, vs), z.on(document, _s, t => this._handleFocusin(t)), z.on(document, bs, t => this._handleKeydown(t)), this._isActive = !0)
		}
		deactivate() {
			this._isActive && (this._isActive = !1, z.off(document, vs))
		}
		_handleFocusin(t) {
			const {
				target: e
			...
			const s = J.focusableChildren(i);
			0 === s.length ? i.focus() : this._lastTabNavDirection === xs ? s[s.length - 1].focus() : s[0].focus()
		}
		_handleKeydown(t) {
			t.key === ys && (this._lastTabNavDirection = t.shiftKey ? xs : ws)
		}
		_getConfig(t) {
			return t = {
				...fs,
	...
	const ks = "modal",
		...
		Os = `resize${Ds}`,
		zs = `click.dismiss${Ds}`,
		Ns = `keydown.dismiss${Ds}`,
		Ls = `mouseup.dismiss${Ds}`,
		$s = `mousedown.dismiss${Ds}`,
		Hs = `click${Ds}.data-api`,
		Ws = "modal-open",
		Rs = "fade",
		js = "show",
		qs = "modal-static",
	...
	class Ks extends H {
		constructor(t, e) {
			super(t), this._config = this._getConfig(e), this._dialog = J.findOne(Bs, this._element), this._backdrop = this._initializeBackDrop(), this._focustrap = this._initializeFocusTrap(), this._isShown = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollBar = new as
		}
		static get Default() {
			return Is
		}
		...
		show(t) {
			...
			z.trigger(this._element, Ms, {
				relatedTarget: t
			}).defaultPrevented || (this._isShown = !0, this._isAnimated() && (this._isTransitioning = !0), this._scrollBar.hide(), document.body.classList.add(Ws), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), z.on(this._dialog, $s, () => {
				z.one(this._element, Ls, t => {
		...
		hide() {
			if (!this._isShown || this._isTransitioning) return;
			if (z.trigger(this._element, As).defaultPrevented) return;
			this._isShown = !1;
			const t = this._isAnimated();
			t && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), this._focustrap.deactivate(), this._element.classList.remove(js), z.off(this._element, zs), z.off(this._dialog, $s), this._queueCallback(() => this._hideModal(), this._element, t)
		}
		dispose() {
			[window, this._dialog].forEach(t => z.off(t, Ds)), this._backdrop.dispose(), this._focustrap.deactivate(), super.dispose()
		}
		handleUpdate() {
			this._adjustDialog()
		}
		...
		_showElement(t) {
			const e = this._isAnimated(),
				i = J.findOne(Ys, this._dialog);
			this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.append(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.scrollTop = 0, i && (i.scrollTop = 0), e && d(this._element), this._element.classList.add(js);
			this._queueCallback(() => {
				this._config.focus && this._focustrap.activate(), this._isTransitioning = !1, z.trigger(this._element, Fs, {
					relatedTarget: t
				})
			}, this._dialog, e)
		}
		_setEscapeEvent() {
			this._isShown ? z.on(this._element, Ns, t => {
				this._config.keyboard && t.key === Es ? (t.preventDefault(), this.hide()) : this._config.keyboard || t.key !== Es || this._triggerBackdropTransition()
			}) : z.off(this._element, Ns)
		}
		_setResizeEvent() {
			this._isShown ? z.on(window, Os, () => this._adjustDialog()) : z.off(window, Os)
		}
		_hideModal() {
			this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._backdrop.hide(() => {
				document.body.classList.remove(Ws), this._resetAdjustments(), this._scrollBar.reset(), z.trigger(this._element, Ps)
			})
		}
		_showBackdrop(t) {
			z.on(this._element, zs, t => {
		...
		_triggerBackdropTransition() {
			if (z.trigger(this._element, Ts).defaultPrevented) return;
			const {
				classList: t,
				scrollHeight: e,
				style: i
			} = this._element, s = e > document.documentElement.clientHeight;
			!s && "hidden" === i.overflowY || t.contains(qs) || (s || (i.overflowY = "hidden"), t.add(qs), this._queueCallback(() => {
				t.remove(qs), s || this._queueCallback(() => {
					i.overflowY = ""
				}, this._dialog)
	...
	z.on(document, Hs, '[data-bs-toggle="modal"]', function(t) {
		const e = s(this);
		["A", "AREA"].includes(this.tagName) && t.preventDefault(), z.one(e, Ms, t => {
			t.defaultPrevented || z.one(e, Ps, () => {
				l(this) && this.focus()
			})
		});
		const i = J.findOne(".modal.show");
		i && Ks.getInstance(i).hide(), Ks.getOrCreateInstance(e).toggle(this)
	}), W(Ks), m(Ks);
	const Vs = "offcanvas",
		Us = "Escape",
		Qs = {
		...
		Js = "show.bs.offcanvas",
		tn = "shown.bs.offcanvas",
		en = "hide.bs.offcanvas",
		sn = "hidden.bs.offcanvas",
		nn = "keydown.dismiss.bs.offcanvas";
	class on extends H {
		constructor(t, e) {
		...
		show(t) {
			...
			if (z.trigger(this._element, Js, {
					relatedTarget: t
				}).defaultPrevented) return;
			this._isShown = !0, this._element.style.visibility = "visible", this._backdrop.show(), this._config.scroll || (new as).hide(), this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.classList.add(Zs);
			this._queueCallback(() => {
				this._config.scroll || this._focustrap.activate(), z.trigger(this._element, tn, {
					relatedTarget: t
				})
			}, this._element, !0)
		}
		hide() {
			if (!this._isShown) return;
			if (z.trigger(this._element, en).defaultPrevented) return;
			this._focustrap.deactivate(), this._element.blur(), this._isShown = !1, this._element.classList.remove(Zs), this._backdrop.hide();
			this._queueCallback(() => {
				this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._element.style.visibility = "hidden", this._config.scroll || (new as).reset(), z.trigger(this._element, sn)
			}, this._element, !0)
		}
		dispose() {
		...
		_addEventListeners() {
			z.on(this._element, nn, t => {
				this._config.keyboard && t.key === Us && this.hide()
			})
		}
		static jQueryInterface(t) {
			return this.each(function() {
	...
	z.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function(t) {
		...
		i && i !== e && on.getInstance(i).hide(), on.getOrCreateInstance(e).toggle(this)
	}), z.on(window, "load.bs.offcanvas.data-api", () => J.find(".offcanvas.show").forEach(t => on.getOrCreateInstance(t).show())), W(on), m(on);
	const an = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
		rn = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i,
		ln = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i,
		hn = (t, e) => {
			const i = t.nodeName.toLowerCase();
			if (e.includes(i)) return !an.has(i) || Boolean(rn.test(t.nodeValue) || ln.test(t.nodeValue));
	...
	function un(t, e, i) {
		...
		for (let t = 0, i = n.length; t < i; t++) {
			...
			const o = [].concat(...i.attributes),
				a = [].concat(e["*"] || [], e[s] || []);
			o.forEach(t => {
				hn(t, a) || i.removeAttribute(t.nodeName)
			})
		}
	...
	class Tn extends H {
		...
		toggle(t) {
			if (this._isEnabled)
				if (t) {
					...
					if (this.getTipElement().classList.contains(yn)) return void this._leave(null, this);
					this._enter(null, this)
				}
		}
		dispose() {
			clearTimeout(this._timeout), z.off(this._element.closest(kn), Dn, this._hideModalHandler), this.tip && this.tip.remove(), this._disposePopper(), super.dispose()
		}
		show() {
			...
			n.setAttribute("id", o), this._element.setAttribute("aria-describedby", o), this._config.animation && n.classList.add(bn);
			...
			L.set(n, this.constructor.DATA_KEY, this), this._element.ownerDocument.documentElement.contains(this.tip) || (l.append(n), z.trigger(this._element, this.constructor.Event.INSERTED)), this._popper ? this._popper.update() : this._popper = Ei(this._element, n, this._getPopperConfig(r)), n.classList.add(yn);
			const h = this._resolvePossibleFunction(this._config.customClass);
			h && n.classList.add(...h.split(" ")), "ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach(t => {
				z.on(t, "mouseover", u)
			});
			const d = this.tip.classList.contains(bn);
			this._queueCallback(() => {
				const t = this._hoverState;
				this._hoverState = null, z.trigger(this._element, this.constructor.Event.SHOWN), t === xn && this._leave(null, this)
			}, this.tip, d)
		}
		hide() {
			...
			t.classList.remove(yn), "ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach(t => z.off(t, "mouseover", u)), this._activeTrigger[Sn] = !1, this._activeTrigger[In] = !1, this._activeTrigger[En] = !1;
			const e = this.tip.classList.contains(bn);
			this._queueCallback(() => {
				this._isWithActiveTrigger() || (this._hoverState !== wn && t.remove(), this._cleanTipClass(), this._element.removeAttribute("aria-describedby"), z.trigger(this._element, this.constructor.Event.HIDDEN), this._disposePopper())
		...
		getTipElement() {
			...
			return this.setContent(e), e.classList.remove(bn, yn), this.tip = e, this.tip
		}
		setContent(t) {
			this._sanitizeAndSetContent(t, this.getTitle(), Cn)
		}
		_sanitizeAndSetContent(t, e, i) {
			const s = J.findOne(i, t);
			e || !s ? this.setElementContent(s, e) : s.remove()
		}
		setElementContent(t, e) {
			if (null !== t) return o(e) ? (e = a(e), void(this._config.html ? e.parentNode !== t && (t.innerHTML = "", t.append(e)) : t.textContent = e.textContent)) : void(this._config.html ? (this._config.sanitize && (e = un(e, this._config.allowList, this._config.sanitizeFn)), t.innerHTML = e) : t.textContent = e)
		}
		getTitle() {
		...
		_setListeners() {
			this._config.trigger.split(" ").forEach(t => {
				if ("click" === t) z.on(this._element, this.constructor.Event.CLICK, this._config.selector, t => this.toggle(t));
					...
					const e = t === En ? this.constructor.Event.MOUSEENTER : this.constructor.Event.FOCUSIN,
						i = t === En ? this.constructor.Event.MOUSELEAVE : this.constructor.Event.FOCUSOUT;
			...
			}), z.on(this._element.closest(kn), Dn, this._hideModalHandler), this._config.selector ? this._config = {
				...this._config,
				trigger: "manual",
				selector: ""
			} : this._fixTitle()
		...
		_enter(t, e) {
			e = this._initializeOnDelegatedTarget(t, e), t && (e._activeTrigger["focusin" === t.type ? In : En] = !0), e.getTipElement().classList.contains(yn) || e._hoverState === wn ? e._hoverState = wn : (clearTimeout(e._timeout), e._hoverState = wn, e._config.delay && e._config.delay.show ? e._timeout = setTimeout(() => {
				e._hoverState === wn && e.show()
			}, e._config.delay.show) : e.show())
		}
		_leave(t, e) {
			e = this._initializeOnDelegatedTarget(t, e), t && (e._activeTrigger["focusout" === t.type ? In : En] = e._element.contains(t.relatedTarget)), e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = xn, e._config.delay && e._config.delay.hide ? e._timeout = setTimeout(() => {
		...
		_getConfig(t) {
			...
			return Object.keys(e).forEach(t => {
				...
				show: t.delay,
				hide: t.delay
			}), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), r(dn, t, this.constructor.DefaultType), t.sanitize && (t.template = un(t.template, t.allowList, t.sanitizeFn)), t
		}
		_getDelegateConfig() {
			const t = {};
	...
	class $n extends Tn {
		...
		setContent(t) {
			this._sanitizeAndSetContent(t, this.getTitle(), Nn), this._sanitizeAndSetContent(t, this._getContent(), Ln)
		}
		_getContent() {
	...
	class so extends H {
		constructor(t, e) {
			super(t), this._scrollElement = "BODY" === this._element.tagName ? window : this._element, this._config = this._getConfig(e), this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, z.on(this._scrollElement, Bn, () => this._process()), this.refresh(), this._process()
		}
		static get Default() {
			return Rn
		}
		...
		refresh() {
			const t = this._scrollElement === this._scrollElement.window ? eo : io,
				...
				s = e === io ? this._getScrollTop() : 0;
			this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), J.find(Gn, this._config.target).map(t => {
				const n = i(t),
					o = n ? J.findOne(n) : null;
				if (o) {
					const t = o.getBoundingClientRect();
					if (t.width || t.height) return [G[e](o).top + s, n]
				}
				return null
		...
		dispose() {
			z.off(this._scrollElement, Wn), super.dispose()
		}
		_getConfig(t) {
			return (t = {
				...Rn,
				...G.getDataAttributes(this._element),
				..."object" == typeof t && t ? t : {}
			}).target = a(t.target) || document.documentElement, r(Hn, t, jn), t
		}
		_getScrollTop() {
		...
		_activate(t) {
			...
			const e = Gn.split(",").map(e => `${e}[data-bs-target="${t}"],${e}[href="${t}"]`),
				i = J.findOne(e.join(","), this._config.target);
			i.classList.add(Vn), i.classList.contains(Kn) ? J.findOne(to, i.closest(Jn)).classList.add(Vn) : J.parents(i, Un).forEach(t => {
				J.prev(t, `${Qn}, ${Zn}`).forEach(t => t.classList.add(Vn)), J.prev(t, Xn).forEach(t => {
					J.children(t, Qn).forEach(t => t.classList.add(Vn))
				})
			}), z.trigger(this._scrollElement, qn, {
				relatedTarget: t
			})
		}
		_clear() {
			J.find(Gn, this._config.target).filter(t => t.classList.contains(Vn)).forEach(t => t.classList.remove(Vn))
		}
		static jQueryInterface(t) {
			return this.each(function() {
	...
	z.on(window, Yn, () => {
		J.find('[data-bs-spy="scroll"]').forEach(t => new so(t))
	}), m(so);
	const no = "tab",
		oo = "hide.bs.tab",
		ao = "hidden.bs.tab",
	...
	class yo extends H {
		...
		show() {
			...
			if (i) {
				const e = "UL" === i.nodeName || "OL" === i.nodeName ? vo : mo;
				t = (t = J.find(e, i))[t.length - 1]
			}
			const n = t ? z.trigger(t, oo, {
				relatedTarget: this._element
			}) : null;
		...
		_activate(t, e, i) {
			const s = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? J.children(e, mo) : J.find(vo, e))[0],
				n = i && s && s.classList.contains(uo),
				o = () => this._transitionComplete(t, s, i);
			s && n ? (s.classList.remove(po), this._queueCallback(o, t, !0)) : o()
		}
		_transitionComplete(t, e, i) {
			if (e) {
				e.classList.remove(co);
				const t = J.findOne(bo, e.parentNode);
				t && t.classList.remove(co), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)
			}
			t.classList.add(co), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), d(t), t.classList.contains(uo) && t.classList.add(po);
			let s = t.parentNode;
			if (s && "LI" === s.nodeName && (s = s.parentNode), s && s.classList.contains(ho)) {
				const e = t.closest(fo);
				e && J.find(_o, e).forEach(t => t.classList.add(co)), t.setAttribute("aria-expanded", !0)
			}
			i && i()
		}
		static jQueryInterface(t) {
	...
	class No extends H {
		...
		show() {
			if (z.trigger(this._element, So).defaultPrevented) return;
			this._clearTimeout(), this._config.animation && this._element.classList.add(To);
			this._element.classList.remove(Po), d(this._element), this._element.classList.add(Mo), this._element.classList.add(Fo), this._queueCallback(() => {
				this._element.classList.remove(Fo), z.trigger(this._element, Ao), this._maybeScheduleHide()
			}, this._element, this._config.animation)
		}
		hide() {
			if (!this._element.classList.contains(Mo)) return;
			if (z.trigger(this._element, Eo).defaultPrevented) return;
			this._element.classList.add(Fo), this._queueCallback(() => {
				this._element.classList.add(Po), this._element.classList.remove(Fo), this._element.classList.remove(Mo), z.trigger(this._element, Io)
			}, this._element, this._config.animation)
		}
		dispose() {
		...
		_getConfig(t) {
			return t = {
				...
				...G.getDataAttributes(this._element),
				..."object" == typeof t && t ? t : {}
			}, r(wo, t, this.constructor.DefaultType), t
		}
		_maybeScheduleHide() {
		...
		_setListeners() {
			z.on(this._element, xo, t => this._onInteraction(t, !0)), z.on(this._element, Co, t => this._onInteraction(t, !1)), z.on(this._element, ko, t => this._onInteraction(t, !0)), z.on(this._element, Do, t => this._onInteraction(t, !1))
		}
		_clearTimeout() {
...
function(t, e) {
		...
		t.effects.animateClass = function(e, i, s, a) {
			return t.isFunction(s) && (a = s, s = null), this.queue(function() {
				...
				t.each(h, function(t, i) {
					e[i] && l[i + "Class"](e[i])
				}), r = o(n.call(this)), l.attr("class", d), l.animate(function(t, e) {
					var i, s = {
						_: 0
					};
		...
		t.effects.bounce = function(e) {
			return this.queue(function() {
				...
				if ("hide" == n) {
					...
					var f;
					d = {};
					(f = {})[h] = ("pos" == c ? "-=" : "+=") + a, d[h] = ("pos" == c ? "+=" : "-=") + a, i.animate(f, l / 2, e.options.easing).animate(d, l / 2, e.options.easing, function() {
		...
		t.effects.fold = function(e) {
			return this.queue(function() {
				...
				var l = t.effects.createWrapper(i).css({
					...
					d = /([0-9]+)%/.exec(o);
				d && (o = parseInt(d[1], 10) / 100 * u["hide" == n ? 0 : 1]), "show" == n && l.css(a ? {
					height: 0,
					width: o
				} : {
					height: o,
				...
				var p = {},
					f = {};
				p[c[0]] = "show" == n ? u[0] : o, f[c[1]] = "show" == n ? u[1] : 0, l.animate(p, r, e.options.easing).animate(f, r, e.options.easing, function() {
					"hide" == n && i.hide(), t.effects.restore(i, s), t.effects.removeWrapper(i), e.callback && e.callback.apply(i[0], arguments), i.dequeue()
				})
			})
		}
		...
		$.extend(Datepicker.prototype, {
			...
			_generateHTML: function(t) {
				...
				var x = t.inline ? "" : '<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" data-handler="hide" data-event="click">' + this._get(t, "closeText") + "</button>",
					C = s ? '<div class="ui-datepicker-buttonpane ui-widget-content">' + (i ? x : "") + (this._isInRange(t, w) ? '<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" data-handler="today" data-event="click">' + y + "</button>" : "") + (i ? "" : x) + "</div>" : "",
					k = parseInt(this._get(t, "firstDay"), 10);
				k = isNaN(k) ? 0 : k;
				for (var D = this._get(t, "showWeek"), E = this._get(t, "dayNames"), I = (this._get(t, "dayNamesShort"), this._get(t, "dayNamesMin")), S = this._get(t, "monthNames"), A = this._get(t, "monthNamesShort"), T = this._get(t, "beforeShowDay"), P = this._get(t, "showOtherMonths"), M = this._get(t, "selectOtherMonths"), F = (this._get(t, "calculateWeek") || this.iso8601Week, this._getDefaultDate(t)), O = "", z = 0; z < a[0]; z++) {
					var N = "";
					this.maxRows = 4;
					for (var L = 0; L < a[1]; L++) {
						var H = this._daylightSavingAdjust(new Date(f, p, t.selectedDay)),
							...
							R = "";
						if (h) {
							if (R += '<div class="ui-datepicker-group', a[1] > 1) switch (L) {
								case 0:
						...
						R += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix' + W + '">' + (/all|left/.test(W) && 0 == z ? i ? b : v : "") + (/all|right/.test(W) && 0 == z ? i ? v : b : "") + this._generateMonthYearHeader(t, p, f, u, d, z > 0 || L > 0, S, A) + '</div><table class="ui-datepicker-calendar"><thead><tr>';
						...
						this.maxRows = U;
						for (var Q = this._daylightSavingAdjust(new Date(f, p, 1 - K)), X = 0; X < U; X++) {
							R += "<tr>";
							var Z = D ? '<td class="ui-datepicker-week-col">' + this._get(t, "calculateWeek")(Q) + "</td>" : "";
							for (q = 0; q < 7; q++) {
								var G = T ? T.apply(t.input ? t.input[0] : null, [Q]) : [!0, ""],
									J = Q.getMonth() != p,
									tt = J && !M || !G[0] || u && Q < u || d && Q > d;
								Z += '<td class="' + ((q + k + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (J ? " ui-datepicker-other-month" : "") + (Q.getTime() == H.getTime() && p == t.selectedMonth && t._keyEvent || F.getTime() == Q.getTime() && F.getTime() == H.getTime() ? " " + this._dayOverClass : "") + (tt ? " " + this._unselectableClass + " ui-state-disabled" : "") + (J && !P ? "" : " " + G[1] + (Q.getTime() == c.getTime() ? " " + this._currentClass : "") + (Q.getTime() == e.getTime() ? " ui-datepicker-today" : "")) + '"' + (J && !P || !G[2] ? "" : ' title="' + G[2] + '"') + (tt ? "" : ' data-handler="selectDay" data-event="click" data-month="' + Q.getMonth() + '" data-year="' + Q.getFullYear() + '"') + ">" + (J && !P ? "&#xa0;" : tt ? '<span class="ui-state-default">' + Q.getDate() + "</span>" : '<a class="ui-state-default' + (Q.getTime() == e.getTime() ? " ui-state-highlight" : "") + (Q.getTime() == c.getTime() ? " ui-state-active" : "") + (J ? " ui-priority-secondary" : "") + '" href="#">' + Q.getDate() + "</a>") + "</td>", Q.setDate(Q.getDate() + 1), Q = this._daylightSavingAdjust(Q)
							}
							R += Z + "</tr>"
	...
	function(t, e) {
		...
		t.fn.position = function(e) {
				...
				return 9 === u.nodeType ? (r = c.width(), l = c.height(), h = {
					top: 0,
					left: 0
				}) : u.setTimeout ? (r = c.width(), l = c.height(), h = {
					top: c.scrollTop(),
					left: c.scrollLeft()
				}) : u.preventDefault ? (e.at = "left top", r = l = 0, h = {
					top: e.of.pageY,
					left: e.of.pageX
				...
				}), 1 === d.length && (d[1] = d[0]), p[0] = parseInt(p[0], 10) || 0, 1 === p.length && (p[1] = p[0]), p[1] = parseInt(p[1], 10) || 0, "right" === e.at[0] ? h.left += r : e.at[0] === n && (h.left += r / 2), "bottom" === e.at[1] ? h.top += l : e.at[1] === n && (h.top += l / 2), h.left += p[0], h.top += p[1], this.each(function() {
					var i, s = t(this),
						a = s.outerWidth(),
						c = s.outerHeight(),
	...
	function(t, e) {
		...
		t.each("branch form header step wrapper".split(" "), function() {
			...
			_create: function() {
				...
				c[0].elements ? e = c : (e = c.find("form")).length || (e = c.closest("form")), (o = c.find(h.header)).length || (o = e.find(h.header)), l.elements = {
				...
				}, u.attr("id") || u.attr("id", "wizard-" + ++i), l.elements.forward.click(function(t) {
					...
					branchesActivated: [],
					stepsActivated: []
				}, l._stepCount = l.elements.steps.length, l._lastStepIndex = l._stepCount - 1, l._branchLabels = [], l.elements.steps.each(function(e) {
					l._branchLabels[e] = t(this).parent().attr("id")
				}), l._excludesFilter = function() {
					return !t(this).hasClass(h.stepClasses.exclude)
				}, h.transitions[r] || (h.transitions[r] = function(t) {
			...
			_find: function(e, i, s) {
				...
				if (null !== e && d.length)
					for (o = 0, r = (e = a(e)).length; o < r; o++) n = null, (c = typeof(h = e[o])) === l ? n = d.get(h) : "string" === c ? n = document.getElementById(h.replace("#", "")) : "object" === c && (h instanceof jQuery && h.length && (h = h[0]), h.nodeType && d.each(p)), n && u.push(n);
				return !1 === s ? u : t(u)
			},
			_move: function(i, s, n, o, a) {
				...
				"boolean" == typeof s && (a = o, o = n, n = s, s = e), !0 === n ? i > 0 ? r._fastForward(i, n, h) : a.call(r, l.stepsActivated[Math.max(0, i + (l.stepsActivated.length - 1))]) : -1 !== (i = r.stepIndex(i, s)) && (i > l.stepIndex ? r._fastForward(i, h) : h.call(r, i))
			},
			_state: function(e, i) {
				if (!this.isValidStepIndex(e)) return null;
				this.options;
				var n = t.extend(!0, {}, this._currentState);
				i = a(i || e), n.step = this.elements.steps.eq(e), n.branch = n.step.parent(), n.branchStepCount = n.branch.children(s.step).length, n.isMovingForward = e > n.stepIndex, n.stepIndexInBranch = n.branch.children(s.step).index(n.step);
				for (var o, r, l, h = 0, c = i.length; h < c; h++) e = i[h], o = this._branchLabels[e], !n.stepIndex || n.stepIndex < e ? t.inArray(e, n.stepsActivated) < 0 && (n.stepsActivated.push(e), t.inArray(o, n.branchesActivated) < 0 && n.branchesActivated.push(o)) : n.stepIndex > e && (r = t.inArray(o, n.branchesActivated) + 1, l = t.inArray(e, n.stepsActivated) + 1, r > 0 && n.branchesActivated.splice(r, n.branchesActivated.length - 1), l > 0 && n.stepsActivated.splice(l, n.stepsActivated.length - 1)), n.stepIndex = e, n.branchLabel = o;
			...
			_transition: function(i, s, n) {
				...
				return (h = t.isFunction(p) ? p.call(l, u, function() {
					return n.apply(l, o.call(arguments))
				}) : d) !== e && !1 !== h && n.apply(l, a(h)), h
			},
			...
			backward: function(t, i) {
				typeof t === l && (i = t, t = e), i === e && (i = 1), this._currentState.isFirstStep || typeof i !== l || this._move(-i, !0, !1, function(e, i) {
			...
			destroy: function() {
				var e = this.elements;
				this._trigger("beforeDestroy", null, this.state()) && (this.element.removeClass("wizard"), e.form.removeClass(n.form), e.header.removeClass(n.header), e.steps.show().removeClass(n.step), e.stepsWrapper.removeClass(n.wrapper), e.branches.removeClass(n.branch), t.Widget.prototype.destroy.call(this), this._trigger("afterDestroy"))
			},
			form: function() {
				return this.elements.form
			},
			forward: function(t, i, s) {
				typeof t === l && (s = i, i = t, t = e), i === e && (i = 1), this._currentState.isLastStep || typeof i !== l || this._move(i, !0, s, function(e, i) {
					this._update(t, this._state(e, i))
				})
			},
			...
			select: function(i, s, n, o, a) {
				i instanceof t.Event || (a = o, o = n, n = s, s = i, i = e), s !== e && (t.isArray(s) ? (a = o, o = n, n = s[1], s = s[0]) : "boolean" == typeof n ? (a = o, o = n, n = e) : t.isArray(n) && (a = n, n = e), this._move(s, n, o, a, function(t, e) {
			...
			step: function(i, s) {
				return arguments.length ? (t.isArray(i) && (s = i[1], i = i[0]), typeof i === l ? o = this._find(i, s !== e ? this.steps(s) : this.elements.steps) : (o = this._find(i, this.elements.steps.add(this.elements.branches))) && o.hasClass(n.branch) && (o = this._find(s || 0, this.steps(o))), o) : this._currentState.step;
				var o
			},
			stepIndex: function(i, n, o) {
				return arguments.length ? (t.isArray(i) ? (o = n, n = i[1], i = i[0]) : "boolean" == typeof n && (o = n, n = e), (a = this.step(i, n)) ? (o ? a.siblings(s.step).andSelf() : this.elements.steps).index(a) : -1) : this._currentState.stepIndex;
				var a
			},
			steps: function(t) {
		...
		t.extend(t.fn, {
			...
			attributeRules: function(e) {
				...
				for (var o in t.validator.methods) {
					var a;
					"required" === o ? ("" === (a = s.get(0).getAttribute(o)) && (a = !0), a = !!a) : a = s.attr(o), /min|max/.test(o) && (null === n || /number|range|text/.test(n)) && (a = Number(a)), a ? i[o] = a : n === o && "range" !== n && (i[o] = !0)
				}
		...
		s.prototype = {
			...
			initEvents_: function() {
				this.events = {
					...
					change: this.onInput_.bind(this),
					focus: this.onFocus_.bind(this),
					input: this.onInput_.bind(this),
			...
			build_: function(t) {
				...
				e && (t.classList.add(this.prefixed_(t.tagName.toLowerCase())), this.setLabel_(e, t), this.setPlaceholder_(e, t), this.wrapLabel_(e, t), this.handleEvents_(t, "add"), "function" == typeof this.config_[this.current_].customEvent && this.config_[this.current_].customEvent.call(this, t))
			},
			...
			wrapLabel_: function(t, e) {
				var i = this.createEl_("div", {
					class: this.prefixed_("wrap") + " " + this.prefixed_("wrap-" + e.tagName.toLowerCase())
				});
