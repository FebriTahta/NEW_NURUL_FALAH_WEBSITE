...
$.fn.countdown = function( method /*, options*/ ) {  
	...
	var defaults = {
			date: new Date("May 20, 2022 16:37:52").getTime(),
			updateTime: 1E3,
		...
		timerFunc = function() {
			...
			now = ( settings.offset === null ) ? new Date("May 20, 2022 16:37:52") : getTZDate( settings.offset );
			date = new Date("May 20, 2022 16:37:52"),
		...
		methods = {		
			init: function( options ) {
				...
				return this.each(function() {
					var $this = $(this),
						settings = {},
						now = ( opts.offset === null ) ? new Date("May 20, 2022 16:37:52") : getTZDate( opts.offset ),
						date = new Date("May 20, 2022 16:37:52"),
