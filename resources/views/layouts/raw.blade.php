                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="featured_properties_right">
                            ...
                            <div class="featured_properties_text">
                                <p>Khotmil Qur'an & Do'a bersama yang diselenggarakan oleh Pesantren Al Qur'an Nurul Falah bersama dengan para santri.
                                    Tahfidz Leader
                                </p>
                            </div>
                                    ...
                                    <div class="footer_input_box">
                                        <div class="row">
                                            <div class="col-sm-6 col-6">
                                                <input type="text" class="form-control" name="text" style="height: 50px" placeholder="Cari..." required>
                                            </div>
                                            <div class="col-sm-6 col-6">
                                                <button type="submit" class="button" style="height: 50px; width: 100%"> <i class="fa fa-search"></i> Cari</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
