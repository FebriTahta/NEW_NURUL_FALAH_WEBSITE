                        ...
                        <div class="container-box clearfix">
                            ...
                            <div class="main-nav__right main-nav__right_one float-right">
                                <div class="header_btn_1">
                                    ...
                                    <a href="/"><img id="mobile_img" src="logo-crop.png"
                                            style="width: 100px; margin-top: 5px;" alt=""></a>
                                </div>
            ...
            <div class="thm-swiper__slider swiper-container" data-swiper-options='{"spaceBetween": 0, "loop": true, "effect": "fade", "slidesPerView": 1, "autoplay": { "delay": 5000 }, "pagination": {
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="image-layer" style="background-image: url(img2.jpg);"></div>
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer" style="background-image: url(img1.png);"></div>
                ...
                <div class="col-lg-12" style="margin-bottom: 15px">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-6 text-muted" style="padding: 0; margin: 0;">
                            ...
                            <span class="badge badge-info" style="opacity: 0.85; font-size: 10px">Nurul Falah</span>
                            <p style="text-transform: uppercase; font-weight: 900">Judul dari artikel itu sendiri</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12" style="margin-bottom: 15px">
                    ...
                    <div class="col-xl-3 col-lg-6 wow fadeInUp" data-wow-delay="00ms">
                        <div class="footer-widget__column footer_widget__about">
                            ...
                            <div class="footer_call_agent_box">
                                ...
                                <div class="text">
                                    <p>Telephone</p>
                                    <a href="tel:92-888-000-2222">(031) 8281278</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="footer_input_box">
                                    <div class="row">
                                        <div class="col-sm-6 col-6">
                                            <input type="text" class="form-control" name="text" style="height: 50px"
                                                placeholder="Cari..." required>
                                        </div>
                                        <div class="col-sm-6 col-6">
                                            <button type="submit" class="button"
                                                style="height: 50px; width: 100%"> <i class="fa fa-search"></i>
                                                Cari</button>
                                        </div>
                                    </div>
                                </div>
