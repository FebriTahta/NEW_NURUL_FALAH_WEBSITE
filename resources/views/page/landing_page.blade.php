            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                ...
                @foreach ($beritas as $item)
                    <div class="overflow-hidden rounded-md drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC] text-center transition-all duration-300 hover:-translate-y-[10px]">
                        ...
                        <div class="py-[20px] px-[20px]">
                            <h3>
                                <a href="properties-details.html" class="font-recoleta leading-tight text-[22px] xl:text-lg text-primary text-uppercase" style="font-size: 16px">
                                    {{substr($item->judul,0,50)}}
                            ...
                            <hr>
                            <h4>
                                <a href="properties-details.html" class="font-light text-tiny text-secondary">
                    ...
                    <div class="container" style="margin-bottom: 20px; background-color: white">
                        <div class="row" style="padding-top: 10px; padding-bottom: 10px">
                            ...
                            <div class="col-md-6 col-6" style="padding-left: 0; margin-left: 0;">
                                <div class="col s6">
                                    <div class="contents">
                                        <h6 style="font-size: 16px; font-weight: 700" class="text-uppercase"><a style="color: rgb(48, 49, 49)" href="/post/{{ $item->jenisposting->slug }}/{{ $item->slug }}">{{$item->judul}}</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
