            ...
            <div class="row clearfix">
                <div class="col-xl-3">
                    <form id="formaddkategori" method="POST"> @csrf
                        <div class="card">
                            <div class="body">
                                <p>- PENULIS POSTINGAN</p>
                                <input type="text" name="name" class="form-control" placeholder="- INPUTKAN NAMA"
                                    required>
                            </div>

                            <div class="body">
                                <input type="submit" id="btnadd" class="form-control btn btn-primary" value="ADD NAMA REDAKSI">
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <form id="formremove" method="POST"> @csrf
                    ...
                    <div class="modal-body">
                        <div class="py-3 text-center">
                            ...
                            <h4 class="heading mt-4">Yakin akan menghapus Penulis Postingan tsb ?</h4>
                            <p>Apabila Si Redaksi postingan tersebut mempunyai artikel / berita / dsb. Sumber postingan tsb tidak dapat dihapus</p>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="formedit" method="POST"> @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal_title_6">Update Data Penulis Postingan</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
...
@section('script')
    ...
    <script>
        ...
        $('#formremove').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('remove.penulis.backend') }}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
