					...
					<div class="owl-stage-outer">
						<div class="owl-stage"
							...
							<div class="owl-item" style="width: 108px; margin-right: 20px;">
								...
								<div class="item_version_2 text_d" style="padding-top: 10px">
									<p style="padding: 0; margin: 0; font-size: 11px" >
										{{$item['judul']}}
									</p>
								</div>
								<div class="item_version_2" style="padding-top: 10px">
									<span class="" style="margin: 0; font-size: 12px; font-weight: 400;" >
										Terkumpul : 
									</span>
									<br style="padding: 0;margin: 0;">
									<span style="margin: 0; font-size: 12px; font-weight: 400;" >Rp {{$item['tercapai_rp']}}</span>
