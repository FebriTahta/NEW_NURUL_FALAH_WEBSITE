        ...
        <div class="container-fluid relative animatedParent animateOnce">
            <div class="tab-content pb-3" id="v-pills-tabContent">
                ...
                <div class="tab-pane animated fadeInUpShort show active" id="v-pills-1">
                        ...
                        <div class="col-md-3">
                            <div class="counter-box white r-5 p-3">
                                <div class="p-4">
                                    ...
                                    <div class="counter-title">Total Slider</div>
                                    <h5 class="sc-counter mt-3"> <span id="total"></span> </h5>
                                </div>
                    ...
                    <button class="btn btn-outline btn-primary btn-sm" data-toggle="modal" data-target="#modaladd"> Tambah
                        Slider</button>
        ...
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content b-0">
                <div class="modal-header r-0 bg-primary">
                    <h6 class="modal-title text-white" id="exampleModalLabel">SLIDER BARU</h6>
                ...
                <form id="formremove" method="POST"> @csrf
                    ...
                    <div class="modal-body">
                        <div class="py-3 text-center">
                            ...
                            <p>Apabila ada postingan yang bersumber dari narasumber ini maka, narasumber ini tidak dapat
                                dihapus</p>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" class="btn btn-secondary btn-sm" id="btndell"
                            value="YA HAPUS!.. SAYA YAQIN!">
                    </div>
                </form>
            </div>
        </div>
...
@section('script')
    ...
    <script>
        ...
        function total() {
            $.ajax({
                type: 'GET',
                url: "{{ route('total.slider.backend') }}",
