        ...
        <div class="container-fluid relative animatedParent animateOnce">
            <div class="tab-content pb-3" id="v-pills-tabContent">
                ...
                <div class="tab-pane animated fadeInUpShort show active" id="v-pills-1">
                        ...
                        <div class="col-md-3">
                            <div class="counter-box white r-5 p-3">
                                <div class="p-4">
                                    ...
                                    <div class="counter-title">Total Wilayah </div>
                                    <h5 class="sc-counter mt-3" id="total_kategori">{{$total_wilayah}}</h5>
                                </div>
                    ...
                    <hr>
                    <button class="btn btn-primary btn-sm" style="margin-bottom: 20px" data-toggle="modal" data-target="#modalimport">Import Wilayah</button>
                    <div class="card">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-body">
                                    <div class="table table-responsive">
                                    <div class="card-title">Kabupaten Indonesia</div>
    ...
    <div class="modal fade" id="modalimport" tabindex="-1" role="dialog" aria-labelledby="modalCreateMessage">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content b-0">
                ...
                <form action="/cabang-wilayah-tilawati/import" method="POST" enctype="multipart/form-data">@csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label form="jenis_id" style="font-size: 14px" class="text-capitalize">Import Data Wilayah </label><br>
                            <input type="file" class="" id="file" name="file" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <input type="submit" class="btn btn-success l-s-1 s-12 text-uppercase" value="IMPORT DATA WILAYAH" id="btnadd" required>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#table-data').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/cabang-wilayah-tilawati/index",
                },
                columns: [
                    {
                        "width": 10,
